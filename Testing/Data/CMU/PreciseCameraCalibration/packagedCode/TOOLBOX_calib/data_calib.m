...
while (Nima_valid==0),
   ...
   disp('Basename camera calibration images (without number nor suffix): SET at [] right now');
   calib_name = [];
   ...
   format_image = '0';
    ...
    disp('Image format: ([]=''r''=''ras'', ''b''=''bmp'', ''t''=''tif'', ''p''=''pgm'', ''j''=''jpg'', ''m''=''ppm'') SET at b right now');
    format_image = 'b';
