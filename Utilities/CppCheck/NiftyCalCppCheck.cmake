...
OPTION(NIFTYCAL_USE_CPPCHECK "Enable the use of CppCheck for static analysis." OFF)
IF(NIFTYCAL_USE_CPPCHECK)
  ...
  IF(CPPCHECK_EXECUTABLE)
    ...
    IF(CPPCHECK_FOUND)
      ...
      #  Define file names
      #
      SET(CPPCHECK_NIFTYCAL_FILES_LIST
        ${PROJECT_BINARY_DIR}/Utilities/CppCheck/NiftyCalFiles.txt)

      #
      # Configure the files
      #
      CONFIGURE_FILE(
        ${PROJECT_SOURCE_DIR}/Utilities/CppCheck/NiftyCalFiles.txt.in
        ${CPPCHECK_NIFTYCAL_FILES_LIST})

      SET(CPPCHECK_ARGUMENTS_CODE
        --file-list=${CPPCHECK_NIFTYCAL_FILES_LIST}
      ...
      ADD_CUSTOM_COMMAND(
        OUTPUT  ${NIFTYCAL_BINARY_DIR}/CppCheckCodeReport.txt
        COMMAND ${CPPCHECK_EXECUTABLE}
        ARGS    ${CPPCHECK_ARGUMENTS_CODE}
        COMMENT "Coding Style Checker"
      )

      ADD_CUSTOM_TARGET(StaticallyAnalyzeCode DEPENDS ${NIFTYCAL_BINARY_DIR}/CppCheckCodeReport.txt)

      ADD_TEST(REQ-2002-CSD-0001-102-01 ${CPPCHECK_EXECUTABLE} ${CPPCHECK_ARGUMENTS_CODE})

    ENDIF(CPPCHECK_FOUND)
  ENDIF(CPPCHECK_EXECUTABLE)
ENDIF(NIFTYCAL_USE_CPPCHECK)
