#/*============================================================================
#
#  NiftyCal: A software platform for medical image computing.
#
...
OPTION(NIFTYCAL_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
IF(NIFTYCAL_USE_KWSTYLE)
...
SET(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/NiftyCalKWS.xml)

SET(KWSTYLE_NIFTYCAL_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/NiftyCalFiles.txt)

SET(KWSTYLE_NIFTYCAL_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/NiftyCalOverwrite.txt )

#
# Configure the files
#
CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/NiftyCalFiles.txt.in
  ${KWSTYLE_NIFTYCAL_FILES_LIST})

CONFIGURE_FILE(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/NiftyCalKWS.xml.in
...
SET(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_NIFTYCAL_FILES_LIST}
  -o ${KWSTYLE_NIFTYCAL_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

ADD_CUSTOM_COMMAND(
  OUTPUT  ${NIFTYCAL_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

ADD_CUSTOM_TARGET(StyleCheckCode DEPENDS ${NIFTYCAL_BINARY_DIR}/KWStyleCodeReport.txt)

ADD_TEST(REQ-2002-CSD-0001-001-01 ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

ENDIF(KWSTYLE_FOUND)
ENDIF(KWSTYLE_EXECUTABLE)
ENDIF(NIFTYCAL_USE_KWSTYLE)
