...
if len(sys.argv) < 8:
    print 'Usage: run_stereo_calibration_with_random_frames.py dirName numberOfPrefixCharacters leftEndsWith rightEndsWith minimumNumberLinesInFile numberOfSamples command'
    exit()
...
for i in file_indexes:
    if len(selected_left_file_names) < int(sys.argv[6]):
