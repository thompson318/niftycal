...
for c in range(0, number_of_columns):
    for r in range(0, number_of_rows):
        xcentre = (spacing_in_pixels * c / 2) + border_in_pixels / 2.0
...
command_string = str("convert -size ") + str(int(image_width_in_pixels)) + "x" + str(int(image_height_in_pixels)) + " xc:white -draw \"" + draw_string + "\" rings.bmp"
