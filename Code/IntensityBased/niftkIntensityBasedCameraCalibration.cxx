                                               ...
                                               )
{
  ...
  currentParams[1] = leftToRightTranslationVector.at<double>(1, 0);
  ...
  leftToRightTranslationVector.at<double>(1, 0) = currentParams[1];

  for (int i = 0; i < rvecsLeft.size(); i++)
  {
    rvecsLeft[i].at<double>(0, 0) = currentParams[(i*6) + 2];
    rvecsLeft[i].at<double>(0, 1) = currentParams[(i*6) + 3];
    rvecsLeft[i].at<double>(0, 2) = currentParams[(i*6) + 4];
    tvecsLeft[i].at<double>(0, 0) = currentParams[(i*6) + 5];
    tvecsLeft[i].at<double>(0, 1) = currentParams[(i*6) + 6];
    tvecsLeft[i].at<double>(0, 2) = currentParams[(i*6) + 7];
  }
