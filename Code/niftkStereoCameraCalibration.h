...
* \param cvFlags can be cv::CALIB_FIX_INTRINSIC, cv::CALIB_USE_INTRINSIC_GUESS, or 0 to optimise all params.
*
...
*/
NIFTYCAL_WINEXPORT void StereoCameraCalibration(const Model3D& model,
